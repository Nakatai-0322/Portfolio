<template>
	<b-navbar toggleable="lg" fixed="top" type="light" variant="light">
		<b-navbar-brand tag="h1" to="/" style="font-weight: bolder">Itsuka</b-navbar-brand>
		<b-navbar-toggle target="nav-collapse" style="border-radius: 0"></b-navbar-toggle>
		...
		<b-collapse id="nav-collapse" is-nav class="animate__animated animate__fadeInDown">
			<b-navbar-nav>
				...
				<b-nav-item href="#" v-if="themeMode == 'dark'" @click="toggleDarkMode" class="moon-icon"
					title="Toggle Darkmode">
					<SunnyIcon style="color: #eee; font-size: 20px" />
				</b-nav-item>
				<b-nav-item href="#" v-else @click="toggleDarkMode" class="moon-icon" title="Toggle Darkmode">
